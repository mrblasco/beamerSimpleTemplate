...
\begin{tikzpicture}
node[rectangle,draw,fill=blue!10] [below=5cm, left=2cm] at (s11) {initialisation};
node[rectangle,draw,fill=green!30,dashed] [below=5cm, right=2cm] at (s11) {shutting down};
node[rectangle,draw,thick,dotted,text width=4cm, text height=2cm] (idle2) [below=7cm, left=1cm] at (s11) {box with height=2cm};
node[rectangle,draw,thick,text width=4cm] (idle) [below=6cm] at (s11) {A textbox containing multi-line text (height is auto)};
\end{tikzpicture}
